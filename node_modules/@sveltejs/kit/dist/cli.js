...
const prog = sade('svelte-kit').version('1.0.0-next.84');
...
export { $, resolve_entry as a, copy as b, copy_assets as c, logger as l, mkdirp as m, posixify as p, rimraf as r };
